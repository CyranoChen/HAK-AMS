...
<body>
	<!--search-->
	<div class="search_1">
		<form action="${ctx}/dwMultiConditionAnalysis/T" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>
				<c:forEach items="${dwMultiConditionAnalysiss}" var="dwMultiConditionAnalysis">
					<tr>
						<td>${dwMultiConditionAnalysis.projectName}</td>
						<td>${dwMultiConditionAnalysis.flightTimes}</td>
						<td>${dwMultiConditionAnalysis.flightTimesRation}</td>
						<td>${dwMultiConditionAnalysis.passengerNum}</td>
						<td>${dwMultiConditionAnalysis.psgRatio}</td>
						<td>${dwMultiConditionAnalysis.viaPsg}</td>
						<td>${dwMultiConditionAnalysis.viaPsgRatio}</td>
						<td>${dwMultiConditionAnalysis.cargoMailWeight}</td>
						<td>${dwMultiConditionAnalysis.cargoMailWeightRatio}</td>
						<td>${dwMultiConditionAnalysis.baggageWeight}</td>
						<td>${dwMultiConditionAnalysis.cargoWeight}</td>
						<td>${dwMultiConditionAnalysis.mailWeight}</td>
						<td>${dwMultiConditionAnalysis.psgLoadRatio}</td>
						<td>${dwMultiConditionAnalysis.carryPsgRatio}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
