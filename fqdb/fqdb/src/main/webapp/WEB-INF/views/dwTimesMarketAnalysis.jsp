...
<body>
	<!--search-->
	<div class="search_1">
		<form action="${ctx}/dwTimesMarketAnalysis" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>
				<c:forEach items="${dwTimesMarketAnalysiss}" var="dwTimesMarketAnalysis">
					<tr>
						<td>${dwTimesMarketAnalysis.carrier}</td>
						<td>${dwTimesMarketAnalysis.flightTimes}</td>
						<td>${dwTimesMarketAnalysis.timesRatio}</td>
						<td>${dwTimesMarketAnalysis.samePeriodTimes}</td>
						<td>${dwTimesMarketAnalysis.samePeriodTimesRatio}</td>
						<td>${dwTimesMarketAnalysis.samePeriodIncrementRatio}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
