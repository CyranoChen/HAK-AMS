...
<body>
	<!--search-->
	<div class="search_1">
		<form action="${ctx}/dwPsgMarketShareAnalysis" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>
				<c:forEach items="${dwPsgMarketShareAnalysiss}" var="dwPsgMarketShareAnalysis">
					<tr>
						<td>${dwPsgMarketShareAnalysis.carrier}</td>
						<td>${dwPsgMarketShareAnalysis.passengerNum}</td>
						<td>${dwPsgMarketShareAnalysis.viaPsg}</td>
						<td>${dwPsgMarketShareAnalysis.psgRatio}</td>
						<td>${dwPsgMarketShareAnalysis.samePeriodPsg}</td>
						<td>${dwPsgMarketShareAnalysis.samePeriodViaPsg}</td>
						<td>${dwPsgMarketShareAnalysis.samePeriodPsgRatio}</td>
						<td>${dwPsgMarketShareAnalysis.samePeriodIncrementRatio}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
