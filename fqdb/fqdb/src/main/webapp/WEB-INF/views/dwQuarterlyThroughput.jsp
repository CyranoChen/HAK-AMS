...
<body>
	<!--search-->
	<div class="search_1">
		<form action="dwQuarterlyThroughput" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>			   
				<c:forEach items="${dwQuarterlyThroughputs}" var="dwQuarterlyThroughput">
					<tr>

						<td>${dwQuarterlyThroughput.quarterName}</td>
						<td>${dwQuarterlyThroughput.flightTimes}</td>
						<td>${dwQuarterlyThroughput.timesYOY}</td>
						<td>${dwQuarterlyThroughput.psgThroughputs}</td>
						<td>${dwQuarterlyThroughput.psgYOY}</td>
						<td>${dwQuarterlyThroughput.cargoMailWeight}</td>
						<td>${dwQuarterlyThroughput.cargoMailYOY}</td>
