...
<body>
	<!--search-->
	<div class="search_1">
		<form action="dwFlightTimesPeak" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>
				<c:forEach items="${dwFlightTimesPeaks}" var="dwFlightTimesPeak">
					<tr>
						<td><fmt:formatDate value="${dwFlightTimesPeak.statDate}"
								pattern="yyyy-MM-dd" /></td>
						<td>${dwFlightTimesPeak.statTime}</td>
						<td>${dwFlightTimesPeak.flightTimes}</td>
						<td>${dwFlightTimesPeak.transportTimes}</td>
						<td>${dwFlightTimesPeak.departTimes}</td>
						<td>${dwFlightTimesPeak.arrivalTimes}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
