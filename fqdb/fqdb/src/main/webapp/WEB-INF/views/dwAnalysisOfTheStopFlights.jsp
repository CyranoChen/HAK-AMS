...
<body>
	<!--search-->
	<div class="search_1">
		<form action="dwAnalysisOfTheStopFlights" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>			   
				<c:forEach items="${dwAnalysisOfTheStopFlightss}" var="dwAnalysisOfTheStopFlights">
					<tr>
						<td>${dwAnalysisOfTheStopFlights.iataRouteAirport}</td>
						<td>${dwAnalysisOfTheStopFlights.decode}</td>
						<td>${dwAnalysisOfTheStopFlights.flightIdentity}</td>
						<td>${dwAnalysisOfTheStopFlights.flightServicetype}</td>
						<td>${dwAnalysisOfTheStopFlights.flightCnt}</td>
						<td>${dwAnalysisOfTheStopFlights.passengersSum}</td>
						<td>${dwAnalysisOfTheStopFlights.viaPassengersSum}</td>
						<td>${dwAnalysisOfTheStopFlights.viaPassengerRatio}</td>
						<td>${dwAnalysisOfTheStopFlights.seatCapacity}</td>
						<td>${dwAnalysisOfTheStopFlights.passengersRatio}</td>
