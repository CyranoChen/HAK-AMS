...
<body>
	<!--search-->
	<div class="search_1">
		<form action="dwNJArriveAircraftType" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>			   
				<c:forEach items="${dwNJArriveAircraftTypes}" var="dwNJArriveAircraftType">
					<tr>
					<c:set var="no" value="${no + 1}" />
					<td>${no}</td>
						<td>${dwNJArriveAircraftType.airLine}</td>
				        <td>${dwNJArriveAircraftType.airportCity}</td>	
				        <td>${dwNJArriveAircraftType.flightTimes}</td>				        
				        <c:set var="flightTimes" value="${flightTimes + dwNJArriveAircraftType.flightTimes}" />
				<td>${dwNJArriveAircraftType.aircraftTypePercentage}%</td> 
					</tr>
				</c:forEach>
				<tr>
				<td>总数</td>
