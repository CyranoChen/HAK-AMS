...
<body>
	<!--search-->
	<div class="search_1">
		<form action="${ctx}/dwMultiConditionAnalysisF" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>
				<c:forEach items="${dwMultiConditionAnalysisFs}" var="dwMultiConditionAnalysisF">
					<tr>
					   <td>${dwMultiConditionAnalysisF.airLine}</td>
