...
<body>
	<!--search-->
	<div class="search_1">
		<form action="dwFlightPsgRatio" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>			   
				<c:forEach items="${dwFlightPsgRatios}" var="dwFlightPsgRatio">
					<tr>
						<td>${dwFlightPsgRatio.flightProject}</td>
				        <td>${dwFlightPsgRatio.io}</td>		
				        <td>${dwFlightPsgRatio.flightType}</td>
				        <td>${dwFlightPsgRatio.flightNumber}</td>
				        <td>${dwFlightPsgRatio.properties}</td>
				        <td>${dwFlightPsgRatio.flightTimes}</td>		
				        <td>${dwFlightPsgRatio.passengerNum}</td>
				        <td>${dwFlightPsgRatio.viaPassengerNum}</td>
				        <td>${dwFlightPsgRatio.flightProject}</td>
				        <td>${dwFlightPsgRatio.seatNum}</td>
				        <td>${dwFlightPsgRatio.psgRatio}</td>				
