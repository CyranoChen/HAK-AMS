...
<body>
	<!--search-->
	<div class="search_1">
		<form action="dwPsgCapacityPeak" method="post" id="form">
	...
	<!--search end-->
	<div>
		<h2 align="center">旅客吞吐量高峰小时统计表</h2>
	</div>
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>
				<c:forEach items="${dwPsgCapacityPeaks}" var="dwPsgCapacityPeak">
					<tr>
						<td><fmt:formatDate value="${dwPsgCapacityPeak.statDate}"
								pattern="yyyy-MM-dd" /></td>
						<td>${dwPsgCapacityPeak.statTime}</td>
						<td>${dwPsgCapacityPeak.psgNum}</td>
						<td>${dwPsgCapacityPeak.departPsgNum}</td>
						<td>${dwPsgCapacityPeak.viaPsgNum}</td>
						<td>${dwPsgCapacityPeak.arrivalPsgNum}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
