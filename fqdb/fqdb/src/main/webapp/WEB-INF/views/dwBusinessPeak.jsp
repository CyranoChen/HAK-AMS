...
<body>
	<!--search-->
	<div class="search_1">
		<form action="dwBusinessPeak" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>
				<c:forEach items="${dwBusinessPeaks}" var="dwBusinessPeak">
					<tr>
						<td>${dwBusinessPeak.timePeriod}</td>
						<td>${dwBusinessPeak.flightTimes}</td>
						<td>${dwBusinessPeak.transportTimes}</td>
						<td>${dwBusinessPeak.psgNum}</td>
						<td>${dwBusinessPeak.departPsgNum}</td>
						<td>${dwBusinessPeak.arrivalPsgNum}</td>
						<td>${dwBusinessPeak.cargoWeight}</td>
						<td>${dwBusinessPeak.departCargoWeight}</td>
						<td>${dwBusinessPeak.arrivalCargoWeight}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
