...
<body>
	<!--search-->
	<div class="search_1">
		<form action="${ctx}/dwCargoMailMarketAnalysis" method="post" id="form">
	...
	<div>
		<table class="table_1" width="100%">
			...
			<tbody>
				<c:forEach items="${dwCargoMailMarketAnalysiss}" var="dwCargoMailMarketAnalysis">
					<tr>
						<td>${dwCargoMailMarketAnalysis.carrier}</td>
						<td>${dwCargoMailMarketAnalysis.cargoMailWeight}</td>
						<td>${dwCargoMailMarketAnalysis.cargoMailRatio}</td>
						<td>${dwCargoMailMarketAnalysis.samePeriodCargoMailWeight}</td>
						<td>${dwCargoMailMarketAnalysis.samePeriodCargoMailRatio}</td>
						<td>${dwCargoMailMarketAnalysis.samePeriodIncrementRatio}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
