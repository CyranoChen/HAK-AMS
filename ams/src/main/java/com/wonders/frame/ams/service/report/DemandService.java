...
public class DemandService {
    ...
    public List<Map<String,Object>> query(String startTime,String endTime,String sqlWhere){
    	...
    	if((startTime!=null&&!("").equals(startTime))&&(endTime!=null&&!("").equals(endTime))){
			sql = sql + " and to_date(t.scheduled_time,'yyyy-MM-dd') between to_date(?,'yyyy-MM-dd') and to_date(?,'yyyy-MM-dd') order by t.SCHEDULED_TIME,t.actual_time,t.LANDING_TIME ";
		}
