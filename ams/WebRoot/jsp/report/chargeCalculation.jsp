...
$(function(){
	...
	$("#export_button").click(function (){
		...
		download("../report/cExport");
	});
	
	var search=function(){
		var source = {
	            url : "../report/queryChargeCalculation",
	            datatype : "json",
	            data : {
	        ...
	        $("#grid").jqxGrid({
                ...
                columns :[
					...
					{datafield:'FLIGHT_PROPERTY',align: "center", cellsalign:"center",text:"任务",width:'100px'},
					{datafield:'VEHICLES',align: "center", cellsalign:"center",text:"架次",width:'100px'},
